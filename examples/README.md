...
The example shows how Megaplan looks in practice: real cycles, phases, backlog items, and status values.
...
- **Phase gating**: Cycle A cannot start until Cycle 0 is complete
